...
var allProfessions = []domain.Profession{
	...
	mk("พนักงานทำความสะอาด", 9_000, 3_500, 15_000,
		domain.Liability{},
		...
		domain.Liability{}),
	mk("พนักงานเสิร์ฟ", 9_500, 3_800, 15_000,
		domain.Liability{},
	...
	mk("คนงานโรงงาน", 12_000, 4_000, 18_000,
		...
		domain.Liability{}),
	mk("พนักงานขายหน้าร้าน", 13_000, 5_000, 18_000,
		domain.Liability{},
	...
	mk("ไรเดอร์รับจ้าง", 14_000, 4_500, 20_000,
		domain.Liability{},
		...
		domain.Liability{}),
	mk("พนักงานออฟฟิศ", 16_000, 6_000, 25_000,
		domain.Liability{},
	...
	mk("ช่างซ่อมรถ", 18_000, 6_000, 30_000,
		domain.Liability{},
	...
	mk("นักบัญชี", 28_000, 9_000, 40_000,
	...
	// ── มืออาชีพ ──
	mk("วิศวกร", 32_000, 10_000, 45_000,
	...
	mk("โปรแกรมเมอร์", 35_000, 11_000, 40_000,
